...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{url('/Createcategory')}}">Create Category</a>
                    <a class="collapse-item" href="{{url('/listcategory')}}">Category list</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseC" class="collapse" aria-labelledby="headingC" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{url('/ucreate')}}">User Create</a>
                    <a class="collapse-item" href="{{url('/ulist')}}">User List</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePro" class="collapse" aria-labelledby="headingPro" data-parent="#accordionSidebar">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{url('/profile')}}">My Profile</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseSetting" class="collapse" aria-labelledby="headingSetting" data-parent="#accordionSidebar">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <h6 class="collapse-header">Edit Setting:</h6>

                    <a class="collapse-item" href="{{url('/setting')}}">Edit</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseContact" class="collapse" aria-labelledby="headingSetting" data-parent="#accordionSidebar">

                <div class="bg-white py-2 collapse-inner rounded">

                    <h6 class="collapse-header">Messages:</h6>

                    <a class="collapse-item" href="{{url('/contactpage')}}">Message</a>
